...
public class MessagePublisher {
    ...
    public void publishDocumentSummarized(final long documentId, final String summary) {
        DocumentSummarizedMessage message = new DocumentSummarizedMessage(documentId, summary);
        try {
